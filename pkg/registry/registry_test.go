...
func TestGetInfoElementFromID(t *testing.T) {
	...
	ie, _ := GetInfoElementFromID(1, IANAReversedEnterpriseID)
	...
	ie, _ = GetInfoElementFromID(1, IANAEnterpriseID)
	...
	ie, _ = GetInfoElementFromID(105, AntreaEnterpriseID)
